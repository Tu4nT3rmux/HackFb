...
def banner():
    ...
    runntxt(WW+"   ..................  ANDA MENCOBA SAYA")
    runntxt(WW+"     ....       HmI.96 (Tu4n.T3rmux) ")
    runntxt(GL+"                   HARUS KEADAAN BERSIH")
    runntxt(GG+"     ..........     MANDI DULU SANA")
    runntxt(Y+"    ............       DILARANG COLI")
    runntxt(GG+"           INGAT COK ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK BF.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Hmi.96/Tu4n.T3rmux             |"
    print GL+"  |       Baca Bismillah Ajg Sebelum Mulai       |"
    print WW+"  |        TEAM : PANOC TEAM            |"
    print Y+"  |             INSTAGRAM: panoc.team             |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK TOLOL  •••••••••|"
    print GG+"  √=============================================√"
...
def pil():
                print GG+" "
                g = str(raw_input("[?] Hack Fb terus..\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
                    ...
                    print RR+"Pilih yang bener bangsat..."
                    pil()
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
             ...
             Powered by:\033[97m TU4N T3RMUX
      """
